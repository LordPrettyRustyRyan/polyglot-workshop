        ...
        <section className={`${backgroundColor} py-16 lg:py-24`}>
            <div className="mx-auto grid max-w-[78%] grid-cols-1 gap-y-10 lg:grid-cols-[0.7fr_1fr] lg:gap-x-5 lg:gap-y-0">
                ...
                <div className="relative aspect-square w-full max-w-full overflow-hidden lg:justify-self-end">
                    <img src="/testimonial-featured.jpg" alt="Featured yoga testimonial" className="absolute inset-0 h-full w-full object-cover" />
                </div>

                {/* ==================== REVIEW CONTENT ==================== */}
                <div className="flex items-center pl-10 sm:pr-10 md:pr-10 lg:pr-0">
                    <div className="max-w-xl">
                        <span className="text-xs tracking-[0.4rem] font-semibold uppercase text-white">
                            Featured Reviews
                        </span>
                        ...
                        <div className="mt-6 flex gap-1 text-white">
                            {[...Array(5)].map((_, i) => (
                        ...
                        <blockquote className="mt-6 font-serif text-lg leading-relaxed text-yoga-olive-dark/90 md:text-xl">
                            "Aliquam faucibus scelerisque odio aliquet platea scelerisque in metus nunc nunc nisl
                            lacus, nec dignissim et, ultricies vitae suspendisse massa egestas velit in massa eget
                            nulla pharetra tortor sagittis sagittis massa nec."
                        </blockquote>
                        ...
                        {showButton && (
                            <div className="mt-8 flex justify-between items-center">
                                ...
                                <button
                                    className="cursor-pointer px-6 py-3 text-xs font-medium uppercase tracking-[0.15em] rounded-full
                                        text-white border border-yoga-olive-dark bg-yoga-olive-dark 
