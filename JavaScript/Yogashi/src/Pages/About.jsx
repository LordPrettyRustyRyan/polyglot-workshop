        ...
        <main className="w-full">
            ...
            <div className="relative flex items-center justify-center overflow-hidden bg-yoga-tropical-teal px-6 py-24 text-center md:px-12">
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center opacity-10">
                    <div className="h-150 w-150 rounded-full border-2 border-yoga-olive-dark"></div>

                    <div className="absolute h-112.5 w-112.5 rounded-full border border-yoga-olive-dark"></div>
                </div>

                {/* ==================== PAGE TITLE ==================== */}
                <h1 className="relative z-10 pb-12 font-serif text-5xl font-normal tracking-wide text-yoga-olive-dark md:pb-16 md:text-7xl">
                    About Us
                </h1>
            ...
            <section className="bg-[#edf4ee] px-6 py-10 text-[#1a2e26] sm:py-10 md:px-16 lg:px-24">
                <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-12 lg:gap-16">
                    ...
                    <div className="relative flex min-h-95 items-center justify-center sm:min-h-110 lg:col-span-6 lg:min-h-140">
                        ...
                        <div className="relative z-10 flex h-full w-full items-end justify-center">
                            <img
                                src="/founder.png"
                                alt="Aashivani, Founder and Instructor"
                                className="relative z-10 h-87.5 w-auto max-w-[90%] object-contain object-bottom sm:h-102.5 md:h-115 lg:h-130"
                            />
                        </div>

                        {/* ==================== FOUNDER NAME ==================== */}
                        <div className="absolute bottom-3 right-[8%] z-20 sm:bottom-5 sm:right-[10%] md:right-[12%] lg:bottom-8 lg:right-[8%]">
                            <span className="whitespace-nowrap font-serif text-3xl italic tracking-wider text-[#b89753] select-none sm:text-4xl md:text-5xl">
                                Aashivani
                            </span>
                        </div>
                    ...
                    <div className="space-y-6 lg:col-span-6">
                        ...
                        {/* ==================== ACCENT LINE ==================== */}
                        <div className="h-0.5 w-12 bg-[#2b6452]" />

                        {/* ==================== QUOTE ==================== */}
                        <blockquote className="font-serif text-xl italic leading-relaxed text-[#1a2e26] sm:text-2xl lg:text-3xl">
                            &ldquo;Lorem ipsum dolor sit amet, consectetur adipiscing elit
                            sed do eiusmod tempor incididunt ut labore et dolore magna
                            aliqua ut enim ad minim veniam.&rdquo;
                        </blockquote>

                        {/* ==================== AUTHOR INFO ==================== */}
                        <div className="space-y-1 pt-4">
                            <h4 className="font-serif text-sm font-semibold uppercase tracking-widest text-[#1a2e26]">
                                Aashivani
                            </h4>

                            <p className="text-xs tracking-wide text-[#52685e]">
                                Founder, Instructor
                            </p>
                        </div>
            ...
            <section className="relative w-full min-h-[600px] lg:min-h-[700px] flex items-center bg-gray-900 overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        // Replace with your actual image path or URL from the reference image[cite: 4]
                        backgroundImage: `url('https://images.unsplash.com/photo-1545205597-3d9d02c29597?auto=format&fit=crop&q=80&w=1600')`
                    }}
                >
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 lg:px-24 w-full py-16">
                    <div className="max-w-md bg-[#edf4ee] text-[#1a2e26] p-8 sm:p-12 shadow-2xl">
                        ...
                        <a
                            href="#discover"
                            className="inline-flex items-center space-x-2 font-semibold text-sm tracking-wide text-[#2b6452] hover:text-[#1a2e26] transition-colors group"
                        >
