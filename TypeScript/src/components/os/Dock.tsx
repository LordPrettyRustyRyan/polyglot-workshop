  ...
  const handleAppClick = (appId: string, appName: string) => {
    ...
    if (existingWindow) {
      ...
      const customSizes: Record<string, { width: number; height: number }> = {
        ...
        video: { width: 695, height: 584 },
        intro: { width: 760, height: 620 },
        utility: { width: 1300, height: 700 },
        terminal: { width: 1300, height: 700 },
        vscode: { width: 1300, height: 700 },
      };
    ...
    <>
      ...
      >
        <div className="dock flex flex-col -translate-y-1/2">
          ...
          <div className="w-8 h-px bg-white/70 mx-auto my-1" />
