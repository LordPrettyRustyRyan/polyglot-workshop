...
const About: React.FC = () => {
  return (
    <div className="bg-[#111111] text-white min-h-screen p-8 md:p-14 font-sans leading-relaxed">
      <p className="font-mono text-[#b7de4a] mb-1.7 text-[1.1rem]">!-- about.html - Aahana Bobade --</p>
      <h1 className="font-stretchpro text-[3.5rem] mb-1.7">About Me</h1>
      <p className="font-mono text-gray-500 mb-8">// who I am · what I do · where I build</p>

      {/* ==================== Bio Section ==================== */}
      <section className="font-mono border border-[#333] p-8 rounded-md mb-6">
        <p className="text-lg">
      ...
      {/* ==================== Focus Section ==================== */}
      <section className="text-[1.2rem] border border-[#333] p-8 rounded-md mb-8">
        <h2 className="text-[#22d3ee] font-medium tracking-widest mb-6">CURRENT FOCUS</h2>
        <div className="font-mono grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          {[
            '🟠 Building scalable end-to-end products',
            '🔴 Deep interest in Game Dev, SaaS platforms & Android',
            '🟣 Currently exploring RAG, Computer Vision & Vector Databases',
            '🔵 Talk to me about Python, APIs, Games',
      ...
      {/* ==================== Education Section ==================== */}
      <section>
        <h2 className="font-sans text-[1.2rem] text-[#22d3ee] font-medium tracking-widest mb-6">EDUCATION</h2>
        
        <div className="font-mono border border-[#333] p-8 rounded-lg mb-4">
          <div className="flex justify-between font-bold mb-2">
            <h3>Post Graduate Government College, Sector-46, Chandigarh</h3>
            <span>2021 – 2024</span>
          </div>
          <p>Panjab University</p>
          <p className="text-[#22d3ee]">Bachelor in Computer Applications</p>
        </div>
      </section>
    </div>
  );
